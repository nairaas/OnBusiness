...
@synthesize networkOperationManager = _networkOperationManager;
...
//        NSLog(@"Data: %@", data);
    ...
    NSDictionary *d = [NSDictionary dictionaryWithObjectsAndKeys:@"aaa2@me.com", @"email", @"bbb", @"password", nil];
    ATAPICreateObjectOperation *op = [[ATAPICreateObjectOperation alloc] initWithObjectCode:@"user/" inputData:d fields:nil
                                         completionHandler:successHandler failureHandler:failureHandler];
    [self.networkOperationManager submitNetworkOperation:op];
*/
    return YES;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"OnBusinessTrip" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"OnBusinessTrip.sqlite"];
...
- (ATNetworkOperationManager *)networkOperationManager {
	...
	return _networkOperationManager;
}
