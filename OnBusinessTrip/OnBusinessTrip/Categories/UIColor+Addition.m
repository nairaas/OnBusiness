...
+ (UIColor *)avatarBorderColor {
	return [UIColor colorWithRed:141 withGreen:152 withBlue:156];
//	return [ColorUtil colorWithRed:111 withGreen:123 withBlue:128];
}

+ (UIColor *)unassignedAvatarBorderColor {
	return [UIColor colorWithRed:125 withGreen:133 withBlue:137];
}


+ (UIColor *)blankAvatarBorderColor {
	return [UIColor colorWithRed:181 withGreen:196 withBlue:202];
}
